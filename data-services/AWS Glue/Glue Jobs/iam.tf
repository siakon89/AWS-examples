...
resource "aws_iam_role" "step_functions_role" {
  name = "${local.project_name}-step-functions-role"
...
# Policy to allow Step Functions to invoke Glue jobs and crawlers
resource "aws_iam_policy" "step_functions_glue_policy" {
  name        = "${local.project_name}-step-functions-glue-policy"
  description = "Policy for Step Functions to invoke Glue jobs and crawlers"
...
resource "aws_iam_role_policy_attachment" "step_functions_glue_attachment" {
  role       = aws_iam_role.step_functions_role.name
  policy_arn = aws_iam_policy.step_functions_glue_policy.arn
}